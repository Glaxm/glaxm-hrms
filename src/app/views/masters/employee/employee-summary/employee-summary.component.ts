...
export class EmployeeSummaryComponent implements OnInit {
  ...
  selectTableRow(data) {
    if (!this.selectRadioBtn && data) {
      this.router.navigate(['/views/masters/employee/emp-info'], { queryParams: { id: data.employeeId, view: this.flags.readFlag == 'Y' && this.flags.createFlag == 'N' && this.flags.editFlag == 'N' ? 'Y' : 'N' } });
    }
  }
  ...
  ngOnInit() {
    ...
    if (this.moduleList) {
      this.moduleList.map((e) => {
        if (e.moduleGroup == 'Profile' && e.moduleName == 'Employee Profile') {
  ...
  add() {
    this.router.navigate(['/views/masters/employee/emp-info'],{ queryParams:{moduleid:this.moduleid}});
  }
  edit() {
    if (this.empId) {
      this.router.navigate(['/views/masters/employee/emp-info'], { queryParams: { id: this.empId, view: 'N',moduleid:this.moduleid } });
    }
  }
  view() {
    if (this.empId) {
      this.router.navigate(['/views/masters/employee/emp-info'], { queryParams: { id: this.empId, view: 'Y',moduleid:this.moduleid } });
    }
  }
  delete() { }
